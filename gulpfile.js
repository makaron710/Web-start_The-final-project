...
//const cssmin      = require('gulp-cssmin'); // Здесь не установлен
//const rename      = require('gulp-rename'); // Здесь не установлен
const autoprefixer = require('gulp-autoprefixer');
const cleanCSS = require('gulp-clean-css');
const minify = require('gulp-minify');
const htmlmin = require('gulp-htmlmin');
const tinypng = require('gulp-tinypng-compress'); // Не настроен
